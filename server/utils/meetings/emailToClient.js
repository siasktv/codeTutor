...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 22px; font-weight: 400;"><strong>¡Has agendado una sesión con ${tutor.fullName} en Code-Tutor!</strong></h1>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="line-height: 140%;">¡Hola, ${client.fullName}!</p>
<p style="line-height: 140%;">Tu sesión de ${session.minutes} minutos programada para el día ${dateToText} a las ${timeToText} hs con ${tutor.fullName} se ha agendado correctamente. Ten en cuenta que si no tienes una zona horaria configurada en tu perfil, la hora mostrada puede no ser la correcta para tu ubicación (por defecto, se muestra la hora de Argentina). Para más información, visita tu panel de Usuario.</p>
  </div>
...
<div align="center">
  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:37px; v-text-anchor:middle; width:215px;" arcsize="11%"  stroke="f" fillcolor="#7f56d9"><w:anchorlock/><center style="color:#FFFFFF;font-family:arial,helvetica,sans-serif;"><![endif]-->  
    <a href="https://code-tutor.dev/user" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #7f56d9; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-family: 'Montserrat',sans-serif; font-size: 14px;">
      <span style="display:block;padding:10px 20px;line-height:120%;"><strong><strong><span style="line-height: 16.8px;">Visitar panel de Usuario </span></strong></strong>➜<strong><strong><span style="line-height: 16.8px;"><br /></span></strong></strong></span>
    </a>
  <!--[if mso]></center></v:roundrect><![endif]-->
</div>
