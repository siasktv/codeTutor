...
const sendAcceptTutorEmail = async user => {
  ...
  try {
    let info = await transporter.sendMail({
      ...
      subject: `¡Hemos aprobado tu solicitud de Tutor! - Code Tutor`, // Subject line
      text: `¡Hemos aprobado tu solicitud de Tutor! - Code Tutor`, // plain text body
      html: `
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-family: 'Montserrat',sans-serif; font-size: 16px; line-height: 140%; text-align: center; word-wrap: break-word;">
    <div>
<div>Hemos aprobado tu perfil de Tutor y ya puedes comenzar a dar clases.</div>
</div>
...
module.exports = sendAcceptTutorEmail
