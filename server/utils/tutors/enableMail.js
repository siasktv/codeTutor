...
const sendEnableTutorEmail = async user => {
  ...
  try {
    let info = await transporter.sendMail({
      ...
      subject: `¡Hemos habilitado tu perfil de Tutor! - Code-Tutor`, // Subject line
      text: `¡Hemos habilitado tu perfil de Tutor! - Code-Tutor`, // plain text body
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 22px; font-weight: 700;">¡Felicidades, ${user.fullName}!</h1>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-family: 'Montserrat',sans-serif; font-size: 16px; line-height: 140%; text-align: center; word-wrap: break-word;">
    <div>
<div>Hemos habilitado tu perfil de Tutor y ya puedes comenzar a dar clases.</div>
</div>
<p style="line-height: 140%;"> </p>
<div>
<div>Recuerda que ahora puedes acceder al panel de tutor desde el apartado de tu usuario y gestionar tu información y estadísticas conforme vayas progresando. También se te solicitará agregar una cuenta bancaria para continuar con el uso de la plataforma con el objetivo de que tus pagos sean 100% automáticos desde el dia cero.</div>
</div>
<p style="line-height: 140%;"> </p>
...
<div align="center">
  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://code-tutor.dev/tutordashboard" style="height:37px; v-text-anchor:middle; width:215px;" arcsize="11%"  stroke="f" fillcolor="#7f56d9"><w:anchorlock/><center style="color:#ffffff;font-family:arial,helvetica,sans-serif;"><![endif]-->  
    <a href="https://code-tutor.dev/tutordashboard" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #7f56d9; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-family: 'Montserrat',sans-serif; font-size: 14px;font-weight: 700; ">
      <span style="display:block;padding:10px 20px;line-height:120%;"><strong>Ir a mi panel de Tutor ➜</strong></span>
    </a>
...
module.exports = sendEnableTutorEmail
