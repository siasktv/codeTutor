        ...
        <div className='flex flex-col pb-6 justify-center items-center w-5/6'>
          <div className='flex flex-row justify-center items-center w-full rounded-md'>
            <div className='flex flex-col items-center justify-center w-full h-full'>
              <h1 className='text-4xl font-bold mt-6'>Detalles de cobros</h1>
                  ...
                  <div className='flex flex-row justify-between items-center w-5/6 space-x-3 px-3 h-full py-3'>
                    <div className='flex flex-col justify-center items-center w-full rounded-md h-full'>
                      ...
                      <h1 className='text-md font-bold text-[#05004E]'>
                        ...
                        <FontAwesomeIcon
                          icon={faQuestionCircle}
                          className='text-sm text-gray-600 hover:text-gray-700 transition-all duration-200 cursor-pointer'
              ...
              bg-red-100 min-h-40 rounded-md'
                  >
                    <p className='text-lg text-[#05004E] font-bold mt-3 mb-2 w-full'>
                    ...
                    <div className='flex flex-col justify-center items-center w-full mb-3'>
                      <ul className='w-full flex flex-col items-center justify-center list-disc list-inside text-gray-600 font-bold'>
                        {disputedPayments.map(payment => (
                          <>
                            <li className='list-item text-md flex-row justify-center items-center w-full px-3'>
                    ...
                    <p className='text-sm text-[#05004E]'>
                      <FontAwesomeIcon
                        icon={faEnvelope}
