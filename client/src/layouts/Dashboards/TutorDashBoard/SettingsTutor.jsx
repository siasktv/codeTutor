...
import { TutorFormBiografia, UpdateModal } from '../../../components'
import { Link } from 'react-router-dom'
import { LoaderMini, Biography, Skills } from '../../../components'
...
export default function SettingsTutor(props) {
  ...
  return (
    <div className="flex flex-col">
      <h1 className="text-4xl font-bold text-center my-8">Ajustes de Tutor</h1>
      <div className="flex gap-11 justify-between">
        <div className="flex flex-col items-center rounded p-8 bg-white border">
          <div className="flex flex-col min-h-[500px] w-full relative rounded-lg">
            ...
            <div className="flex flex-col mx-4 space-y-4 mt-4">
              <div className="flex flex-row items-center justify-between  p-3 rounded-lg">
        ...
        <div className="flex flex-col w-full gap-[18px] ">
          ...
          <Skills bio={user.tutor.bio} id={user.tutor._id} />
        </div>
      </div>
    </div>
  )
