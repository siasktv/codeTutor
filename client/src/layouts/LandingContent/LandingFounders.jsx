      ...
      <section class='text-gray-600 body-font flex justify-center w-full '>
        <div class=' w-full py-24'>
          <div class='flex flex-col text-center w-full mb-20'>
            <h1 class='text-4xl font-medium title-font mb-4 text-blackcodecolor'>
              Conoce a los fundadores
            </h1>
            <p class=' w-screen  leading-relaxed text-base'>
              ...
              <div class='h-full flex flex-col items-center text-center'>
                ...
                <div class='w-full'>
                  ...
                  <p class='mb-4'>
                    ...
                    y MERN stacks. Soy una persona proactiva, con capacidad de
                    adaptación y aprendizaje en ambientes profesionales.
                    <br />
                    <span className='italic'>
                      "La base de un buen proyecto es la experiencia que le
                      damos al usuario".
                    </span>
                  </p>
                </div>
