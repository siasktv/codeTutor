...
const CardTutor = (props) => {
  ...
  return (
    <div>
      <div className="pb-5 ">
        <div className=" flex p-4 sm:p-6 lg:p-8 border justify-between dark:bg-gray-800 dark:border-gray-800 bg-white  rounded-lg">
          {/* Imagen de perfil */}
          <div className="flex flex-col">
            <div className="rounded-full overflow-hidden w-14 h-14 sm:grid  lg:h-20 lg:w-20 sm:shrink-0 sm:place-content-center sm:rounded-full">
          ...
          >
            ...
            <div className="pt-2 pb-2 flex max-lg:hidden lg:justify-between items-center">
              <div className="flex space-x-3">
                <h2 className="font-semibold  text-sm dark:text-gray-200 dark:font-semibold">
                  {tutor.bio.specialty}
                </h2>
              ...
              {tutor.reviews && (
                <h2 className="font-semibold  text-sm dark:text-gray-400">
                  {tutor.reviews.length} Reviews
                </h2>
              )}
            </div>
            <div className="pt-2 pb-2 flex lg:hidden flex-col items-start space-y-1">
              <h1 className="text-md font-semibold dark:text-gray-200">
                {tutor.bio.specialty}
              </h1>
              <div className="flex items-center space-x-2">
                <div className="flex justify-center items-center space-x-2">
            ...
            <div className="pt-2 pb-2">
              <div className="lg:grid lg:grid-cols-6 lg:gap-3 flex flex-wrap">
          ...
          {user && user.uid !== tutor.user.uid ? (
            <button
              className="flex max-lg:hidden justify-center items-center w-12 h-12 bg-codecolor shadow-xl rounded-lg transition duration-1 ease-in-out transform active:scale-95 active:outline-none focus:outline-none"
              type="button"
              title="Contactar"
              onClick={(event) => handleShowMessage(event, tutor)}
            >
            ...
            <button
              className="flex max-lg:hidden justify-center items-center w-12 h-12 bg-gray-400 shadow-xl dark:bg-gray-700 rounded-lg transition duration-1 ease-in-out transform active:outline-none focus:outline-none cursor-default"
              type="button"
              title="Inicia sesión para contactar"
              onClick={(event) => event.preventDefault()}
            >
