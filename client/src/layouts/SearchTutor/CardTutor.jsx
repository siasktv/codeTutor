      ...
      <div className='pb-5'>
        <div className='flex lg:p-9 p-5 justify-between dark:bg-gray-800 dark:border-gray-800 bg-white border border-gray-200 shadow-md rounded-lg'>
          ...
          {user && user.uid !== tutor.user.uid ? (
            ...
            <button
              className='flex max-lg:hidden justify-center items-center w-16 h-16 bg-gray-400 shadow-xl rounded-2xl transition duration-1 ease-in-out transform active:outline-none focus:outline-none'
              type='button'
              title='Contactar'
              onClick={
                user
