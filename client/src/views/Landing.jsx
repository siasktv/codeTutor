          ...
          <div class="w-full lg:max-w-lg lg:w-1/2 rounded-xl">
            <div>
              <div class="relative w-full max-w-lg">
                <div class="absolute top-0 rounded-full bg-violet-300 -left-4 w-px500 h-px500 mix-blend-multiply "></div>

                <div class="absolute rounded-full bg-violet-300 -bottom-0 right-20 w-96 h-96 mix-blend-multiply "></div>
                <div class="relative">
                  <img class="object-cover object-center mx-auto rounded-lg shadow-2xl" alt="hero" src="src\assets\heroimg.png"/>
                </div>
              </div>
            </div>
          </div>
