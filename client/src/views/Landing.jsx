import { NavLogin, LandingDropdown } from '../components'
import {
  videocallicon,
  collaboration,
  Duolingo,
          ...
          <div className='flex flex-col items-start  ml-0 text-left lg:flex-grow  lg:w-1/2 lg:pl-6 xl:pl-5 md:mb-0 xl:mt-0'>
            ...
            <div className='flex-col mt-0 lg:mt-6 max-w-7xl sm:flex'>
              ...
              <form
                ...
                name='revue-form'
                target='_blank'
                className='h-10 w-125 p-0 mt-0  bg-gray-50 rounded-md ring-1 ring-offset-2 ring-gray-400 sm:flex shadow-md shadow-gray-400'
              >
                <svg
