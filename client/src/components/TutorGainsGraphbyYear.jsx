...
const TutorGainsGraphbyYear = props => {
  ...
  useEffect(() => {
    ...
    setPriceData(prices.map(price => price * 0.9)) // Multiply by 0.9
  }, [tutorSessions])
  ...
  const delta = calculateDeltaPercentage(
    priceData[currentMonth - 2],
    priceData[currentMonth - 1]
  )
  ...
  return (
    <div className='flex justify-center'>
      <Card className='w-full my-4'>
        <Title>Ganancias totales este año (USD)</Title>
...
export default TutorGainsGraphbyYear
