    ...
    <>
      ...
      <div className='flex flex-row justify-start flex-wrap'>
        {selectedTechs.map((tech, index) => (
          <div
            className='bg-[#7D5AE21A] mr-2 lg:mr-3 max-w-[200px] justify-center lg:p-4 mb-2 flex flex-row items-center text-[#7D5AE2] max-lg:py-2 max-lg:px-3 max-lg:text-sm lg:py-3 rounded-[8px] dark:bg-codecolor dark:text-codecolorlighter'
            key={index}
          >
            ...
            <FontAwesomeIcon
              ...
              className='ml-2 mt-[1px] hover:text-codecolordark dark:text-codecolorlighter cursor-pointer'
              size='sm'
            />
          </div>
        ))}
