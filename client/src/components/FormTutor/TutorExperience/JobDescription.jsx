      ...
      <textarea
        className={
          errorsData.description
            ? 'w-full h-40 py-3 px-6 bg-none rounded-[8px] border border-red-500 focus:outline-red-500 resize-none dark:bg-gray-800 dark:outline-none dark:text-gray-200 dark:focus:outline-none'
            : 'w-full h-40 py-3 px-6 bg-none rounded-[8px] border dark:bg-gray-800 dark:outline-none dark:text-gray-200 dark:focus:outline-none dark:border-none border-[#C3D3E2] resize-none'
        }
        maxLength={500}
