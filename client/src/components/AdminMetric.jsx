...
const AdminMetric = () => {
  ...
  const currentMonthProfit = currentMonthPrice * 0.10;
  const previousMonthProfit = previousMonthPrice * 0.10;
  ...
  const categories = [
    {
      ...
      delta: previousMonthFormattedPrice !== 0 ? `${delta.toFixed(1)}%` : "No posees datos del mes anterior",
    ...
    },
    {
      ...
      delta: previousMonthProfit !== 0 ? `${deltaProfit.toFixed(1)}%` : "No posees datos del mes anterior",
    ...
    },
    {
      ...
      delta: previousMonthSessions !== 0 ? deltaSessionsFormatted : "No posees datos del mes anterior",
