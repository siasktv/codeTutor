                    ...
                    <div className='w-full flex flex-col'>
                      {user && (
                        <>
                          <button
                            className={
                              selectedSection === 'dashboard'
                                ...
                                : 'text-black p-2 dark:hover:bg-codecolor hover:bg-codecolor transition ease-in-out duration-150 hover:text-white dark:bg-gray-800 dark:text-gray-200 font-semibold w-full bg-white'
                            }
                            tabIndex='-1'
                            onClick={() => {
                          ...
                          <button
                            className='text-red-500 dark:hover:bg-red-500 p-2 hover:bg-red-500 transition ease-in-out duration-150 hover:text-white font-semibold dark:bg-gray-800  w-full bg-white'
                            role='menuitem'
                            tabIndex='-1'
                            id='menu-item-1'
