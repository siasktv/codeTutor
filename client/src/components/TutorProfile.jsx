          ...
          <div className="pb-6 border-b">
            ...
            <div>
              ...
              <div className=" pb-6 flex justify-start items-center">
                ...
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" clip-rule="evenodd" d="M2 3C2 2.44772 2.44772 2 3 2H13C13.5523 2 14 2.44772 14 3V13C14 13.5523 13.5523 14 13 14H3C2.44772 14 2 13.5523 2 13V3ZM13 3H3V13H13V3Z" fill="#141414" fill-opacity="0.7"/>
                  <path fillRule="evenodd" clip-rule="evenodd" d="M11 1C11.2761 1 11.5 1.22386 11.5 1.5V3.5C11.5 3.77614 11.2761 4 11 4C10.7239 4 10.5 3.77614 10.5 3.5V1.5C10.5 1.22386 10.7239 1 11 1Z" fill="#141414" fill-opacity="0.7"/>
                  <path fillRule="evenodd" clip-rule="evenodd" d="M5 1C5.27614 1 5.5 1.22386 5.5 1.5V3.5C5.5 3.77614 5.27614 4 5 4C4.72386 4 4.5 3.77614 4.5 3.5V1.5C4.5 1.22386 4.72386 1 5 1Z" fill="#141414" fill-opacity="0.7"/>
                  <path fillRule="evenodd" clip-rule="evenodd" d="M2 5.5C2 5.22386 2.22386 5 2.5 5H13.5C13.7761 5 14 5.22386 14 5.5C14 5.77614 13.7761 6 13.5 6H2.5C2.22386 6 2 5.77614 2 5.5Z" fill="#141414" fill-opacity="0.7"/>
                </svg>
                {/* Empresa */}
