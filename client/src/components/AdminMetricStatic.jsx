...
import { CashIcon, TicketIcon, UserGroupIcon,ClockIcon,VideoCameraIcon } from "@heroicons/react/solid";
  ...
  const categories = [
    {
      ...
      metric: allSessionsData.earnings ? `$ ${allSessionsData.earnings.toLocaleString()}` : "-",
      icon: TicketIcon,
      color: "violet",
    },
    {
      title: "Ganancias desde inicio (10%)",
      metric: allSessionsData.earnings ? `$ ${(allSessionsData.earnings * 0.10).toLocaleString()}` : "-",
      icon: CashIcon,
      color: "violet",
    },
    {
