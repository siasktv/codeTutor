      ...
      <div className='fixed z-[10000] inset-0 overflow-y-auto'>
        <div className='flex items-end justify-center h-[650px] lg:min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
          ...
          <span
            ...
            aria-hidden='true'
          ></span>
          <div className='inline-block align-bottom max-lg:absolute max-lg:top-1/2 max-lg:-translate-y-1/2 max-lg:w-[95%] bg-white rounded-lg text-left overflow-hidden dark:shadow-none shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full'>
