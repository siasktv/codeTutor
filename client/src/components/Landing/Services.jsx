...
const Services = () => {
  return (
    <div className="relative items-center mt-36 w-full lg:px-8 max-lg:px-3 py-8">
      ...
      <div className="grid w-full grid-cols-1 max-lg:gap-3 lg:gap-12 mx-auto lg:grid-cols-3 lg:px-20">
        <Link
          to="/search"
          className="p-6 border rounded-xl bg-white dark:bg-gray-800 dark:border-gray-800 shadow-lg group cursor-pointer hover:bg-codecolor hover:-translate-y-2 hover:shadow-2xl transition-all duration-300"
        >
