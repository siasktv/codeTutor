      ...
      <div className="mx-auto max-w-screen-xl p-4">
        <div className="flex items-center justify-between gap-4 lg:gap-10">
          ...
          <div className="hidden flex-1 items-center justify-end gap-4 sm:flex">
            <a className="rounded-lg px-5 py-2 text-sm font-medium hover:rounded-lg hover:bg-codecolor hover:text-white hover:outline-4 hover:outline-violet-300 hover:outline" href="">
              Iniciar sesión
            </a>
