                            ...
                            <div className="pb-5 relative inline-block text-left">
                                <div>
                                    <button type="button" id="dropdown-menu-button" aria-haspopup="true" aria-expanded="false" className="inline-flex justify-center items-center pb-4 pt-4 pr-2 w-full rounded border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-codecolor">
                                        <svg className="-ml-1 mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 25" fill="none">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M5.25 12.5C5.25 12.0858 5.58579 11.75 6 11.75H18C18.4142 11.75 18.75 12.0858 18.75 12.5C18.75 12.9142 18.4142 13.25 18 13.25H6C5.58579 13.25 5.25 12.9142 5.25 12.5Z" fill="#141414"/>
                                            <path fillRule="evenodd" clipRule="evenodd" d="M1.5 8C1.5 7.58579 1.83579 7.25 2.25 7.25H21.75C22.1642 7.25 22.5 7.58579 22.5 8C22.5 8.41421 22.1642 8.75 21.75 8.75H2.25C1.83579 8.75 1.5 8.41421 1.5 8Z" fill="#141414"/>
                                            <path fillRule="evenodd" clipRule="evenodd" d="M9 17C9 16.5858 9.33579 16.25 9.75 16.25H14.25C14.6642 16.25 15 16.5858 15 17C15 17.4142 14.6642 17.75 14.25 17.75H9.75C9.33579 17.75 9 17.4142 9 17Z" fill="#141414"/>
                                        </svg>
                                        <span className='pr-5'>
                                            Filtrar por país
                                        </span>
                                        <svg className="-mr-1 ml-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                            <path fillRule="evenodd" d="M10 12a1 1 0 0 1-.707-.293l-4-4a1 1 0 1 1 1.414-1.414L10 9.586l3.293-3.293a1 1 0 0 1 1.414 1.414l-4 4A1 1 0 0 1 10 12z" clipRule="evenodd" />
                                        </svg>
                                    </button>
                                </div>
                            ...
                            <div className="flex p-9 justify-between bg-white border border-gray-200 shadow-md rounded-lg">
                                ...
                                >
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M1.75 6.5C1.75 3.87665 3.87665 1.75 6.5 1.75H17.5C20.1234 1.75 22.25 3.87665 22.25 6.5V12C22.25 14.6234 20.1234 16.75 17.5 16.75H13.7663L7.42786 21.9C6.43412 22.7074 5.01331 21.6761 5.47294 20.4811L6.90798 16.75H6.5C3.87665 16.75 1.75 14.6234 1.75 12V6.5ZM6.5 3.25C4.70507 3.25 3.25 4.70507 3.25 6.5V12C3.25 13.7949 4.70507 15.25 6.5 15.25H7.27199C8.14921 15.25 8.75357 16.13 8.43867 16.9487L7.20943 20.1447L12.8893 15.5299C13.1121 15.3488 13.3904 15.25 13.6775 15.25H17.5C19.2949 15.25 20.75 13.7949 20.75 12V6.5C20.75 4.70507 19.2949 3.25 17.5 3.25H6.5Z" fill="white"/>
                                        <path fillRule="evenodd" clipRule="evenodd" d="M6.75 11.3574C6.75 10.9432 7.08579 10.6074 7.5 10.6074H16.5C16.9142 10.6074 17.25 10.9432 17.25 11.3574C17.25 11.7716 16.9142 12.1074 16.5 12.1074H7.5C7.08579 12.1074 6.75 11.7716 6.75 11.3574Z" fill="white"/>
                                        <path fillRule="evenodd" clipRule="evenodd" d="M6.75 8C6.75 7.58579 7.08579 7.25 7.5 7.25H12C12.4142 7.25 12.75 7.58579 12.75 8C12.75 8.41421 12.4142 8.75 12 8.75H7.5C7.08579 8.75 6.75 8.41421 6.75 8Z" fill="white"/>
                                    </svg>
                                </button>
                            </div>
                        </div>
